...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>cerveja.biz - Alterar País</title>
                    ...
                    <form action="ManterPais.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="area" id="area" maxlength="15" placeholder="area do país" value="${pais.area }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="populacao">Populacao</label>
                                <input type="number" class="form-control" name="populacao" id="populacao" required maxlength="60" placeholder="população obrigatório" value="${pais.populacao }">
                            </div>
                        </div>
                        <hr />
