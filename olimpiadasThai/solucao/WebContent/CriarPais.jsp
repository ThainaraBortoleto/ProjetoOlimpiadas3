        ...
        <form action="ManterPais.do" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" name="area" id="area" maxlength="15" placeholder="digite a area do país">
                </div>

                <div class="form-group col-md-6">
                    <label for="populacao">E-Mail</label>
                    <input type="number" class="form-control" name="populacao" id="populacao" required maxlength="60" placeholder="População">
                </div>
            </div>
            <hr />
